...
// /// **'ACCESSORIES'**
const String web296CategoryNameAccessories = 'Phụ kiện';
//
...
// /// In en, this message translates to:
// /// **'Search'**
const String web296TooltipSearch = 'Tìm kiếm';
//
...
// /// In en, this message translates to:
// /// **'Close menu'**
const String web296TooltipCloseMenu = 'Đóng';
//
...
// /// In en, this message translates to:
// /// **'Close cart'**
const String web296TooltipCloseCart = 'Đóng giỏ hàng';
//
...
const String web296ScreenReaderCart = 'web296ScreenReaderCart';
//
...
// /// In en, this message translates to:
// /// **'Add to cart'**
const String web296ScreenReaderProductAddToCart =
    'Thêm vào giỏ hàng';
//
...
// /// In en, this message translates to:
// /// **'Remove {product}'**
const String web296ScreenReaderRemoveProductButton =
    'Xóa ProductButton';

// /// **'Add {product}'**
const String web296ScreenReaderAddProductButton =
    'Thêm';
//
